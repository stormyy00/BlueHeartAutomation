  ...
  try {
    ...
    const response = await ollama.chat({
      ...
      messages: [
        {
          role: "system",
          content: `You are an editor and you are tasked to to compile all these events into a newsletter in order to inform the user in an automated email provide only the newsletter response. Seperate newsletters are seperated by END OF NEWSLETTER. Newsletters on either side of this statement are seperate.",
