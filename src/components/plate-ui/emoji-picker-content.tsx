...
export function EmojiPickerContent({
    ...
    return emojiLibrary
      ...
      .map(({ id: categoryId }) => {
        ...
        return (
          <div
            key={categoryId}
            ref={section.root as unknown as React.RefObject<HTMLDivElement>}
  ...
  return (
    <div
      ref={
        refs.current.contentRoot as unknown as React.RefObject<HTMLDivElement>
      }
      className={cn(
    ...
    >
      <div
        ref={refs.current.content as unknown as React.RefObject<HTMLDivElement>}
        className="h-full"
      >
